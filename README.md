...
The HuggingFace website holds the output files generated by the CoLab notebooks for ~12 models including:

- add_**d5_l1**_h3_t30K_s372001: Inaccurate **5-digit, 1-layer, 3-attention-head**, addition model. This reproduces Paper 1.
- add_d5_**l2**_h3_t15K_s372001: **Accurate** 5-digit, **2-layers**, 3-head addition model trained for 15K epochs. 
- add_**d6**_l2_h3_t15K_s372001: **Accurate** **6-digit**, 2-layers, 3-head addition model trained for 15K epochs.  
- **ins1**_mix_d6_l3_h4_t40K_s372001: **Accurate** 6-digit, 3-layers, 4-head mixed (addition and subtraction) model **initialised with addition model** add_d6_l2_h3_t15K_s372001. 

Refer [Hugging_Models](./hugging_models.md) for details on all 12 models and all file types. 
